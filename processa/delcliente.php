...
mysqli_query($link,$query) or die('Erro ao alterar os dados '.mysqli_error($link));
		...
		if ($linhas2>=1) {	
echo "<META HTTP-EQUIV=REFRESH CONTENT = '0; URL=http://localhost/admin/listaclientes.php'><script type=\"text/javascript\">alert(\"Usuario apagado com Sucesso.\");</script>;";
