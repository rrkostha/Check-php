...
$query ="INSERT INTO categoria (nome,created) VALUES ('$nome',now())";
mysqli_query($link,$query) or die('Erro ao inserir os dados '.mysqli_error($link));
		$linhas2=mysqli_affected_rows($link);
		if ($linhas2>=1) {	
echo "<META HTTP-EQUIV=REFRESH CONTENT = '0; URL=http://localhost/admin/listacatprodutos.php'><script type=\"text/javascript\">alert(\"Categoria cadastrada com Sucesso.\");</script>;";
