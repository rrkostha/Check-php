  ...
  $id =$_GET['id'];
  $query ="SELECT * FROM  categoriacliente WHERE id=$id LIMIT 1";
 ...
 <h3 class="page-header">Editar categorias</h3>
   ...
   <form action="../processa/editcatcli.php" method="POST" autocomplete="off">
                                                      ...
                                                      <div id="actions" class="row">
                                                        <div class="col-md-12">
                                                          <button type="submit" class="btn btn-primary" onclick="return validar()">Alterar</button>
                                                           <a href="listacatclientes.php" class="btn btn-secondary"><i class="fa fa-list-alt"></i> Lista todos</a>
